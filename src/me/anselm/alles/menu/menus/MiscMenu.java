...
public class MiscMenu extends Menu {
    ...
    public MiscMenu(MenuType menuType) {
        super(menuType);
    }

    @Override
    public void addButton() {
        addButtonToPanel(new ApplicationButton(Applications.RAINBOW));
        addButtonToPanel(new ApplicationButton(Applications.OPEN_GL));
        addButtonToPanel(new ApplicationButton(Applications.RAINDROP));
